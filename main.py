...
font = pygame.font.Font('sunshine.ttf',30)
...
def button(msg,size,rectcol,inact,color,x,y,sizex,sizey,action = None):
    font = pygame.font.Font('sunshine.ttf',size)
...
def pause():
    ...
    while p:
        ...
        gamedisplay.blit(font.render("Game Paused..!!",True,grey),[100,90])
        button("Resume",20,darkgrey,grey,black,50,130,100,25,"pause")
        if 100 < cur[0] < 200 and 130 < cur[1] < 155:
            if click[0] ==1:
                p=False
            
        button("Restart",20,darkgrey,grey,black,155,130,100,25,"start")
        button("Mainmenu",20,darkgrey,grey,black,260,130,100,25,"startscreen")   
...
def startscreen():
    ...
    while intro==True:
        ...
        gamedisplay.blit(font.render("Main Menu",True,red),[100,90])
...
def gameloop():
    ...
    while not gameexit:
        ...
        while gameover == True :
            ...
            gamedisplay.blit(font.render("Game Over..!!",True,grey),[100,90])
            button("Restart",20,darkgrey,grey,black,100,130,100,25,"start")
            button("Mainmenu",20,darkgrey,grey,black,210,130,100,25,"startscreen")   
            pygame.display.update()
